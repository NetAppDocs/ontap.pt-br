...
NOTE: A partir do ONTAP 9.19.1, é necessário inserir um código TOTP válido ou um código de emergência para excluir a chave secreta TOTP usando a CLI. Não é possível excluir a chave secreta TOTP usando a API REST.
