...
NOTE: A partir do ONTAP 9.19.1, você deve inserir um código TOTP válido ou um código temporário para excluir sua chave secreta TOTP usando a CLI do ONTAP. Você não pode excluir sua chave secreta TOTP usando a API REST do ONTAP.
