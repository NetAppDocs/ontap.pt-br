...
`-lower-challenge-boundary`
 a| 
O limite inferior percentual do desafio de autenticação multifator (MFA). O intervalo válido é de 0 a 99. O valor 100 é inválido, pois faz com que todas as solicitações sejam negadas. O valor padrão é 0.
 a| 
