...
summary: 'Você pode gerenciar a disponibilidade do serviço iSCSI nas interfaces lógicas iSCSI da máquina virtual de storage usando os comandos `vserver iscsi interface enable` ou `vserver iscsi interface disable`.' 
---
