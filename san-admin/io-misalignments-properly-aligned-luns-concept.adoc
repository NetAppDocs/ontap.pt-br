...
summary: ONTAP pode reportar desalinhamentos de entrada e saída em LUNs devidamente alinhadas. Em geral, esses avisos de desalinhamento podem ser ignorados, desde que você tenha certeza de que seu LUN está provisionado corretamente e sua tabela de particionamento está correta. 
---
