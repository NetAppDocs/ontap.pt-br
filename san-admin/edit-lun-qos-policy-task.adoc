...
summary: A partir do ONTAP 9.10.1, você pode usar System Manager para atribuir ou remover políticas de qualidade do serviço em vários LUNs simultaneamente. 
---
