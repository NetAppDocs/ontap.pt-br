...
summary: Em ambientes SAN, os sistemas de storage são destinos que possuem dispositivos de destino de storage. Para iSCSI e FC, os dispositivos de destino de storage são chamados de LUNs. Para Non-Volatile Memory Express sobre Fibre Channel, os dispositivos de destino de storage são chamados de namespaces. 
---
