...
summary: 'O protocolo Challenge Handshake Authentication Protocol (CHAP) permite a comunicação autenticada entre iniciadores iSCSI e alvos. Ao usar autenticação CHAP, você define nomes de usuário e senhas CHAP tanto no iniciador quanto no sistema de storage.' 
---
