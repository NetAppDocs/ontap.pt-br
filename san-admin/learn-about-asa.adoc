...
summary: Os NetApp All-Flash SAN Arrays estão disponíveis a partir do ONTAP 9.7. Os ASAs são soluções SAN all-flash construídas em plataformas AFF NetApp comprovadas. 
---
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Relatório técnico da NetApp 4080: Práticas recomendadas para SAN moderna"^]
