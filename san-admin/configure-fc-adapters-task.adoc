...
. Se você possui um sistema AFF, ASA ou FAS, siga estas etapas para criar uma LIF: Se você possui um sistema ASA r2, siga link:https://docs.netapp.com/us-en/asa-r2/administer/manage-client-vm-access.html#create-a-lif-network-interface["este procedimento do System Manager"^] para criar uma LIF.
+
