...
summary: Os grupos de iniciadores são tabelas de WWPNs de hosts do protocolo FC ou nomes de nós de hosts iSCSI. Você pode definir grupos de iniciadores e mapeá-los para LUNs para controlar quais iniciadores têm acesso aos LUNs. 
---
= Saiba mais sobre os igroups SAN do ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
