...
summary: O Selective LUN Map reduz o número de caminhos do host até o LUN. Com o SLM, quando um novo mapa de LUN é criado, o LUN fica acessível apenas por meio de caminhos no nó proprietário do LUN e em seu parceiro de HA. 
---
