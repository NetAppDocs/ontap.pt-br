...
. Selecione *Habilitar NVMe/FC* ou *Habilitar NVMe/TCP*.
. Se você estiver habilitando NVMe/TCP e desejar que os caminhos de rede façam failover automático para o parceiro de HA em caso de falha de um nó, faça o seguinte:
+
