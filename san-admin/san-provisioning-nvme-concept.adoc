...
summary: A partir do ONTAP 9.4, o NVMe FC é suportado em ambiente SAN. O NVMe FC permite que os administradores de storage provisionem namespaces e subsistemas e, em seguida, mapeiem os namespaces para subsistemas, de forma semelhante ao provisionamento e mapeamento de LUNs para igroups em FC e iSCSI. 
---
...
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Relatório técnico da NetApp 4684: Implementando e configurando SANs modernas com NVMe/FC"^]
