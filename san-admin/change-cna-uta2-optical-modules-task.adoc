...
summary: Você deve trocar os módulos ópticos no adaptador de destino unificado para que sejam compatíveis com o modo de personalização selecionado para o adaptador. 
---
