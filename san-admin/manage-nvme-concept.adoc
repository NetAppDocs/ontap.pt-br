...
summary: 'Você pode usar o protocolo Non-Volatile Memory Express (NVMe) para fornecer armazenamento em um ambiente SAN. O protocolo NVMe é otimizado para desempenho com armazenamento de estado sólido.' 
---
= Visão geral do NVMe
:allow-uri-read: 
:icons: font
