...
| xref:../networking/configure_ip_security_@ipsec@_over_wire_encryption.html[Certificados IPsec (Internet Protocol Security)] | As diretivas IPsec oferecem suporte a chaves pré-compartilhadas (PSKs), além de certificados de autenticação. 
