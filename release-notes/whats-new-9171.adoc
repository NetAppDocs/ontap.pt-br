...
| Atualização | Descrição 
 ...
 a| 
xref:../anti-ransomware/index.html[Suporte adicional ao hipervisor]
 a| 
A partir do ONTAP 9.17.1P5, a Proteção Autônoma contra Ransomware oferece suporte a Hyper-V, KVM e OpenStack hipervisores.



 a| 
xref:../anti-ransomware/index.html[Atualizações de snapshots da proteção autônoma contra ransomware]
 a| 
O ONTAP introduz diversas atualizações nos snapshots ARP/AI.
