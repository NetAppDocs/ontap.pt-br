...
+
Estende a Proteção Autônoma contra Ransomware (ARP/AI) para SnapMirror synchronous (SAN e NAS) e SnapMirror active sync ambientes SAN, preservando os sinais de detecção e recuperação em arquiteturas de RPO zero. 
