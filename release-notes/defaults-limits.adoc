...
| Proteção autônoma contra ransomware (ARP) | O ARP/AI é ativado automaticamente por padrão em todos os novos volumes após um período de carência de 12 horas em plataformas compatíveis. | ONTAP 9.18.1 
