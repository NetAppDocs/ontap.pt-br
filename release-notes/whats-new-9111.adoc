...
| Na API REST do ONTAP, os grupos de consistência suportam um procedimento de snapshot em duas fases, permitindo que você realize uma verificação prévia antes de confirmar o snapshot. 
|===
