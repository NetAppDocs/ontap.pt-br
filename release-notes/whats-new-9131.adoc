...
* xref:../anti-ransomware/support-arpai.html#multi-admin-verification-with-arp-ai-protected-volumes[Verifique a funcionalidade com o Autonomous ransomware Protection]
...
A partir do ONTAP 9.12.1, o System Manager é integrado ao NetApp Console. Saiba mais sobre xref:../concepts/sysmgr-integration-console-concept.html[Integração do System Manager com o NetApp Console] .
