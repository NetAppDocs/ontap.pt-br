...
A partir do ONTAP 9.12.1, o System Manager é integrado ao NetApp Console. Saiba mais sobre xref:../sysmgr-integration-console-concept.html[Integração do System Manager com o NetApp Console] .
