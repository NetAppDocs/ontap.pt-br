...
NOTE: Objetos multipartes em buckets S3 NAS devem estar alinhados em tamanhos inteiros, não parciais. Por exemplo, uma parte pode ter 4MB, 4GB ou um tamanho similar. Uma parte não pode usar tamanhos parciais ou sub-MB, como 4.5MB ou 4000.5MB.
...
* CopyObject não suportado em volumes SnapLock
...
* A partir do ONTAP 9.16.1, há suporte para metadados com objetos de parte única.
...
* A partir do ONTAP 9.16.1, há suporte para tags com objetos de parte única.
