...
NOTE: Essas S3 ações não são especificamente suportadas ao usar o S3 em buckets do nas S3. Ao usar buckets nativos do S3, essas ações são link:../s3-config/ontap-s3-supported-actions-reference.html["suportado como normal"].
