...
+
.. Clique em *Armazenamento > VMs de armazenamento*, selecione uma VM de armazenamento pronta para NAS, clique em *Configurações* e, em seguida, em *Protocolos > S3*, clique image:icon_gear.gif["Ícone ações"] em S3.
...
. Habilite o S3 em uma VM de storage com protocolos nas configurados.
+
.. Clique em *Cluster > VMs de armazenamento*, selecione uma VM de armazenamento pronta para NAS, clique em *Configurações* e, em seguida, em *Protocolos > S3* clique image:icon_gear.gif["Ícone ações"].
.. Selecione o tipo de certificado. Se você selecionar um certificado gerado pelo sistema ou um de seu, ele será necessário para acesso ao cliente.
.. Introduza as interfaces de rede.
...
+
** A chave secreta não será exibida novamente.
** Se você precisar das informações do certificado novamente: clique em *Cluster > VMs de armazenamento*, selecione a VM de armazenamento e clique em *Configurações*.
