...
* link:https://docs.netapp.com/us-en/ontap-cli/security-key-manager-external-enable.html["gerenciador de chaves de segurança-habilitação externa"^]
* link:https://docs.netapp.com/us-en/ontap-cli/security-key-manager-external-show-status.html["gerenciador de chaves de segurança externo mostrar status"^]
