...
Escopo da SVM
 a| 
O MetroCluster é suportado a partir do ONTAP 9.8.

A partir do ONTAP 9.6, o NVE oferece suporte ao escopo SVM somente para gerenciamento de chaves externas, não para o Onboard Key Manager.
