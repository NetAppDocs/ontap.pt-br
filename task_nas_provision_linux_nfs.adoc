...
---
= Provisione armazenamento NFS para servidores Linux com o ONTAP System Manager
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Você pode criar volumes FlexVol ou, para sistemas de arquivos grandes com requisitos de alto desempenho, pode criar volumes FlexGroup . Veja tambémlink:./flexgroup/create-task.html["Criar volumes FlexGroup"] .
