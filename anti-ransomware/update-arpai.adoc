...
summary: Mantenha a proteção ARP/AI atualizada contra as ameaças de ransomware mais recentes, atualizando automaticamente ou manualmente os pacotes de segurança ARP/AI independentemente da cadência de lançamento do ONTAP. 
---
...
NOTE: O ARP (ONTAP 9.10.1 a 9.15.1) não suporta atualizações automáticas do modelo de segurança. Os recursos de detecção de segurança são atualizados somente com as atualizações de software do ONTAP. Se você estiver executando o ONTAP 9.15.1 ou anterior, consulte link:index.html["Saiba mais sobre proteção autônoma contra ransomware."].
...
NOTE: Certifique-se de instalar apenas uma atualização ARP/AI mais recente do que a sua versão atual para evitar qualquer downgrade acidental do ARP/AI.
...
* link:learn-about-arpai.html["Saiba mais sobre ARP/IA"]
