...
* Após a atualização para ONTAP 9.19.1 RC e a ativação do ARP em volumes que fazem parte de SnapMirror síncronos ou SnapMirror active sync relationships, o relacionamento pode apresentar um breve estado de dessincronização. Essa condição é temporária e o relacionamento será ressincronizado automaticamente, sem necessidade de intervenção.
