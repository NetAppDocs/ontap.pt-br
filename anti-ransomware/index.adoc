...
.Modo ativo
Para ARP em execução com ONTAP 9.10,1 a 9.15.1, o ARP muda para _ative mode_ após o intervalo de aprendizagem ideal ser concluído. Depois que o ARP mudou para o modo ativo, o ONTAP cria instantâneos ARP para proteger os dados se uma ameaça for detetada.
