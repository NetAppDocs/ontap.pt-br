...
+
*** Para avisos sobre tipos de arquivo, selecione *Atualizar e limpar tipos de arquivo suspeitos*.
...
. A partir da versão 9.18.1, você pode determinar o status do `clear-suspect` operação:
+
[source, cli]
----
