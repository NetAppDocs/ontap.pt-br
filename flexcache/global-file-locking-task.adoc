...
[role="lead"]
A partir do ONTAP 9.10.1, você pode aplicar o bloqueio global de arquivos em volumes FlexCache para impedir leituras em todos os arquivos em cache relacionados.
