...
Compatível a partir do ONTAP 9.5.  O SVM primário de um relacionamento SVM DR pode ter o volume de origem; no entanto, se o relacionamento SVM DR for interrompido, o relacionamento FlexCache deverá ser recriado com um novo volume de origem.
 a| 
Não
