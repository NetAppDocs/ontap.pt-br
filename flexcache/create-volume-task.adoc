...
* Certifique-se de que os nomes dos volumes FlexCache tenham 197 caracteres ou menos.
...
.System Manager
--
. Se o FlexCache volume estiver em um cluster ONTAP diferente do volume de origem, crie um relacionamento de peers de clusters:
+
