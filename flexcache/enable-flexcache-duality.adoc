...
NOTE: Para obter documentação mais completa sobre FlexCache dualidade, consulte link:../s3-multiprotocol/index.html#how-s3-multiprotocol-support-works["Suporte multiprotocolo ONTAP S3"^].
