...
summary: Os recursos do ONTAP permitem habilitar operações não disruptivas para dois aplicativos da Microsoft por meio do protocolo SMB - Microsoft Hyper-V e Microsoft SQL Server. 
---
