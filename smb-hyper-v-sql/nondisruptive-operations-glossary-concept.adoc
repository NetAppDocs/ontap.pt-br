...
summary: Existem alguns conceitos sobre operações não disruptivas que você deve entender antes de configurar sua solução Hyper-V ou Microsoft SQL Server sobre SMB. 
---
