...
|===
+
Saiba mais sobre  `statistics catalog object show` e  `statistics catalog counter show` no link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics+catalog["Referência do comando ONTAP"^] .
