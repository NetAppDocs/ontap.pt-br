...
summary: Você precisa criar volumes de dados NTFS na máquina virtual de storage antes de configurar compartilhamentos continuamente disponíveis para uso com servidores de aplicativos Hyper-V ou Microsoft SQL Server sobre SMB. Use a planilha de configuração de volume para criar seus volumes de dados. 
---
