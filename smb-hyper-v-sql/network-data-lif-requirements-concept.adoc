...
summary: É necessário estar ciente de certos requisitos de rede e de LIF de dados ao criar configurações do SQL Server ou Hyper-V sobre SMB para operações não disruptivas. 
---
