...
summary: É importante que você conheça alguns conceitos essenciais para entender como o Remote VSS é utilizado pelos serviços de backup em configurações Hyper-V sobre SMB. 
---
