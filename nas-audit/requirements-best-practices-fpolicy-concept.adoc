...
Saiba mais sobre  `fpolicy persistent-store create` no link:https://docs.netapp.com/us-en/ontap-cli/vserver-fpolicy-persistent-store-create.html["Referência do comando ONTAP"^] .
