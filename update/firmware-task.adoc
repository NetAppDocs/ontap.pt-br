...
summary: Você pode aplicar uma atualização de firmware aos dispositivos compatíveis em seu cluster, como discos, gabinetes de discos, o service processor ou o Baseboard Management Controller. 
---
...
[role="lead"]
A partir do ONTAP 9.9.1, se você estiver registrado no link:https://docs.netapp.com/us-en/active-iq/["Consultor digital"^], poderá receber alertas no System Manager que informam quando atualizações de firmware para dispositivos compatíveis, como disco, gabinetes de disco, o processador de serviço (SP) ou o Baseboard Management Controller (BMC), estiverem pendentes no cluster.

Se você estiver usando ONTAP 9.8 ou não estiver registrado no Digital Advisor, acesse o site de suporte da NetApp para baixar as atualizações de firmware.
...
.Passos
Siga o procedimento adequado com base na sua versão do ONTAP e se você está registrado no Digital Advisor.
