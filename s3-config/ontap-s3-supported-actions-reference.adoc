...
.ONTAP 9.11,1
O ONTAP 9.11,1 adiciona suporte para controle de versão, URLs pré-assinados, uploads em grupo e suporte para ações S3 comuns, como criar e excluir buckets usando APIs do S3.
...
.ONTAP 9.10,1
ONTAP 9.10,1 adiciona suporte para S3 SnapMirror e GetBucketLocation.
