...
=== O método de autenticação é nsswitch e LDAP está habilitado exemplo:
...
(Possível quando o LDAP está desativado ou utilizadores não POSIX em que o UID e o GID não estão configurados.)
