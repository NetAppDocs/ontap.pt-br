...
A partir do ONTAP 9.19.1, você pode usar condições para impor gravações condicionais para uploads de objetos e exclusões condicionais para exclusões de objetos. Gravações e exclusões condicionais oferecem uma maneira de evitar sobrescritas ou exclusões não intencionais de objetos.
...
----
A partir do ONTAP 9.19.1, você pode usar condições para impor gravações condicionais para uploads de objetos e exclusões condicionais para exclusões de objetos. O exemplo a seguir cria uma condição de política de bucket para impor gravações condicionais para o bucket1:
