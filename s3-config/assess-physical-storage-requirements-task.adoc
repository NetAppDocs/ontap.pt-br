...
.Sobre esta tarefa
Ao criar um bucket S3 em uma SVM habilitada para S3, um volume FlexGroup é link:../s3-config/architecture.html#automatic-flexgroup-sizing-with-ontap-9-14-1-and-later["criado automaticamente"] criado para suportar o bucket. Você pode deixar o ONTAP selecionar automaticamente os agregados subjacentes e os componentes FlexGroup (padrão), ou você pode selecionar os agregados subjacentes e os componentes FlexGroup manualmente.
...
* https://www.netapp.com/pdf.html?item=/media/17251-tr4571a.pdf["Relatório técnico da NetApp 4571-a: Melhores práticas de volume da NetApp ONTAP FlexGroup"^]
