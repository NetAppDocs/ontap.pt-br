...
.. *Excluir permanentemente versões não atuais*: Especifique o número de dias após os quais a versão se torna não atual e, posteriormente, pode ser excluído, e o número de versões a reter.
