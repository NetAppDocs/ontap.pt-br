...
A partir do ONTAP 9.19.1, as configurações de conexão direta FC e FC-NVMe são suportadas para determinados sistemas AFF, ASA r2 e FAS. As configurações de conexão direta não suportam migração SVM.
