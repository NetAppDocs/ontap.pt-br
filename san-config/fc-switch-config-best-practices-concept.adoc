...
Para obter as melhores práticas de FC e iSCSI, consulte  https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Relatório técnico da NetApp 4080: Práticas recomendadas para SAN moderna"^].
