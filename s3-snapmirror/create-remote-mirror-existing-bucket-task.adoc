...
summary: Você pode começar a proteger buckets S3 existentes a qualquer momento, por exemplo, se tiver atualizado uma configuração S3 de uma versão anterior ao ONTAP 9.10.1. 
---
