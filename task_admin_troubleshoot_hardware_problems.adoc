...
---
= Solucione problemas de hardware com o ONTAP System Manager
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.2+| Plataforma 11+| Suportado no Gerenciador de sistema na versão ONTAP... 


| 9.18.1 | 9.17.1 | 9.16.1 | 9.15.1 | 9.14.1 | 9.13.1 | 9.12.1 | 9.11.1 | 9.10.1 | 9.9.1 | 9,8 (apenas modo de pré-visualização) 
...
Sim
 ...
 a| 
* Instale as atualizações mais recentes para visualizar esses dispositivos.
