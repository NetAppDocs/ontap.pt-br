...
summary: Adicione endereços IP ao criar uma sub-rede ou adicione ou remova endereços IP de uma sub-rede existente. 
---
= Adicionar ou remover endereços IP de uma sub-rede ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
