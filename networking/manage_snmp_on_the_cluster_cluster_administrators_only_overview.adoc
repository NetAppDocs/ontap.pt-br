...
summary: Configure o SNMP para monitorar as SVMs em seu cluster. 
---
...
Para obter mais informações sobre o suporte a SNMP em sistemas ONTAP, consulte  https://www.netapp.com/pdf.html?item=/media/16417-tr-4220.pdf["TR-4220: Suporte SNMP no Data ONTAP"^].
