...
summary: Utilize DNS para acessar fontes locais ou remotas para informações sobre o host. 
---
= Configure o DNS para resolução de nomes de host no ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
