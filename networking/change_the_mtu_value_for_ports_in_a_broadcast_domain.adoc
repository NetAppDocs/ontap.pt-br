...
summary: Modifique o valor de MTU para um domínio de broadcast para alterar esse valor para todas as portas no domínio de broadcast. 
---
...
.System Manager
--
A partir do ONTAP 9.12.0, você pode usar System Manager para modificar o valor de MTU de um domínio de broadcast para alterar o valor de MTU de todas as portas nesse domínio de broadcast.
