...
summary: Visualize todas as conexões ativas ou em escuta no cluster ou uma contagem de conexões ativas no nó por cliente, LIF, protocolo ou serviço. 
---
...
Saiba mais sobre  `network connections active show-protocols` na link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=network+connections+active+show-protocols["Referência do comando ONTAP"^].
