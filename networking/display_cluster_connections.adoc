...
Saiba mais sobre o comando link:http://docs.NetApp.com/US-en/ONTAP-cli/network-connections-active-show-clients.html[`network connections active show-clients`] na referência de comando ONTAP.
