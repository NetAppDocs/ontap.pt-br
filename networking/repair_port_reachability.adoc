...
summary: Se uma porta for recabeada ou a configuração do switch for alterada, pode ser necessário reparar a porta em um domínio de broadcast diferente, novo ou existente. 
---
