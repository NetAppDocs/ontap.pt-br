...
summary: Atribua políticas de serviço às LIFs para especificar o tráfego suportado. 
---
= Políticas de serviço ONTAP LIF
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
IMPORTANT: Os protocolos FCP e NVMe/FCP atualmente não exigem uma service-policy.
...
NOTE: Os aplicativos em um LIF com uma política de serviço vazia podem se comportar inesperadamente.
