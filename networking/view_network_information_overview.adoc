...
summary: Visualize e baixe informações relacionadas a portas, LIFs, rotas, regras de failover, grupos de failover, regras de firewall, DNS, NIS e conexões. 
---
= Informações de rede que você pode visualizar no ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
