...
summary: Altere o endereço da sub-rede, o valor da máscara, o endereço do gateway ou o intervalo de endereços IP. 
---
= Alterar propriedades da sub-rede do ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
