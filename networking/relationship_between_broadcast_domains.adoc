...
summary: Domínios de broadcast, grupos de failover e políticas de failover trabalham em conjunto para determinar qual porta assumirá em caso de falha. 
---
= Como funcionam os domínios de broadcast, grupos de failover e políticas do ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
