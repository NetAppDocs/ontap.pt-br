...
summary: Utilize protocolos de descoberta de vizinhos para visualizar a conectividade de rede entre um par de sistemas físicos ou virtuais e suas interfaces de rede. 
---
= Protocolos de descoberta de vizinhos para conectividade de rede do ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
