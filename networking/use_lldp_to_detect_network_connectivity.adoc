...
O LLDP também deve estar habilitado em todos os switches e roteadores Ethernet antes que as informações sobre os dispositivos vizinhos possam ser exibidas.
...
* As informações exibidas podem variar entre o cluster e o switch Ethernet.
+
Os dados de ID do chassi e ID da porta exibidos pelo switch Ethernet podem ser diferentes para portas CNA e não-CNA.
