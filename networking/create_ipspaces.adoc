...
[NOTE]
====
A partir da versão 9.19.1 do ONTAP, o ONTAP aprimora o desempenho da transferência de dados TCP em links WAN com perdas e alta latência, integrando dois recursos de recuperação de perda à pilha TCP do ONTAP: PRR e RACK. link:improve-tcp-wan-performance.html["Saiba como melhorar o desempenho da WAN TCP com PRR e RACK"]
