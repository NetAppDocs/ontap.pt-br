...
Uma licença não é necessária se você usar NetApp StorageGRID ou ONTAP S3 para a camada de nuvem. Cloud Volumes ONTAP não requer uma licença FabricPool, independentemente do provedor que você estiver usando.
