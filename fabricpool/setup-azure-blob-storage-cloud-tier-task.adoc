...
* A link:install-license-aws-azure-ibm-task.html["Licença FabricPool"] é necessária ao migrar para o Azure Blob Storage a partir de clusters ONTAP locais.
* Não é necessária nenhuma licença se você estiver usando o Armazenamento de Blobs do Azure no Cloud Volumes ONTAP ou no Azure NetApp Files.
