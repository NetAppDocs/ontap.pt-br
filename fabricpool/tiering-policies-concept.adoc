...
---
= Sobre as políticas de disposição em camadas do FabricPool
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
====
Você pode usar o `volume object-store tiering show` comando para exibir o status de disposição em camadas de um volume FabricPool. Para obter mais informações, consulte link:https://docs.netapp.com/us-en/ontap-cli/["Referência do comando"].
