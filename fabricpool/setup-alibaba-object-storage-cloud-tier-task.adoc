...
* A link:https://console.netapp.com/cloud-tiering["Licença NetApp Cloud Tiering"^] é necessária ao usar o tiering para Alibaba Cloud Object Storage. Para mais informações, consulte link:install-license-aws-azure-ibm-task.html["Instale uma licença FabricPool em um cluster do ONTAP"].
