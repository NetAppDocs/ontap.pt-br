...
* É necessário um link:install-license-aws-azure-ibm-task.html["Licença FabricPool"] ao migrar para o Alibaba Cloud Object Storage a partir de clusters ONTAP locais.
