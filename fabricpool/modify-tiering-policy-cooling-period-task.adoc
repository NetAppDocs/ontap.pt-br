...
link:tiering-policies-concept.html#what-happens-when-you-modify-a-volume-tiering-policy["O que acontece quando você modifica uma política de escalonamento de volume"]
...
** `none`
+
link:tiering-policies-concept.html["FabricPool políticas de escalonamento de volume"]
