...
---
= Gerenciar a disposição em camadas de storage modificando a política de disposição em camadas de um volume ou o período mínimo de resfriamento em camadas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
