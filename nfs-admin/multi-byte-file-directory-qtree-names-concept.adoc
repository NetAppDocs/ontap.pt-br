...
summary: A partir do ONTAP 9.5, o suporte para nomes codificados em UTF-8 de 4 bytes permite a criação e exibição de nomes de arquivos, diretórios e árvores que incluem caracteres suplementares Unicode fora do Plano Multilíngue Básico. Em versões anteriores, esses caracteres suplementares não eram exibidos corretamente em ambientes multiprotocolo. 
---
