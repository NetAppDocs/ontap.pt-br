...
summary: Você pode configurar ONTAP para permitir que clientes NFS acessem dados com estilo de segurança NTFS e que clientes NTFS acessem dados com estilo de segurança NFS. Ao usar o estilo de segurança NTFS em um armazenamento de dados NFS, você deve decidir como tratar o acesso do usuário raiz e configurar a máquina virtual de storage de acordo. 
---
