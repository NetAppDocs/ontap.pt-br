...
*MELHOR PRÁTICA:* Deve-se usar NFSv4.1 ou NFSv4.2 em vez de NFSv4.0. NFSv4.0 é uma versão mais antiga do protocolo NFS e não é mais desenvolvido ativamente pela comunidade NFS.
