...
sidebar: sidebar 
keywords: use, ldap 
summary: Um servidor LDAP permite que você mantenha informações de usuários de forma centralizada. Se você armazena seu banco de dados de usuários em um servidor LDAP em seu ambiente, pode configurar seu sistema de storage para buscar informações de usuários em seu banco de dados LDAP existente. 
---
...
Para obter informações adicionais, consulte https://www.netapp.com/pdf.html?item=/media/19423-tr-4835.pdf["Relatório técnico do NetApp 4835: Como configurar o LDAP no ONTAP"^].
