...
summary: Você pode habilitar ou desabilitar o acesso NFS a máquinas virtuais de armazenamento via TCP e UDP modificando os parâmetros -tcp e -udp, respectivamente. Isso permite controlar se os clientes NFS podem acessar dados via TCP ou UDP em seu ambiente. 
---
