...
summary: ONTAP utiliza a semântica de segurança do sistema de arquivos Windows NT para determinar se um usuário UNIX, em um cliente NFS, tem acesso a um arquivo com permissões NTFS. 
---
