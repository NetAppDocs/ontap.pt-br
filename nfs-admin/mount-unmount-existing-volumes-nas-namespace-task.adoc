...
summary: Um volume precisa ser montado no namespace NAS antes que você possa configurar o acesso do cliente NAS aos dados contidos nos volumes da máquina virtual de armazenamento. Você pode montar um volume em um ponto de junção se ele ainda não estiver montado. Você também pode desmontar volumes. 
---
