...
summary: Você deve concluir uma série de etapas para permitir o acesso dos clientes a arquivos em máquinas virtuais de armazenamento usando NFS. Há algumas etapas adicionais que são opcionais, dependendo da configuração atual do seu ambiente. 
---
