...
summary: Para especificar o período de bloqueio do NFSv4, você pode modificar a opção -v4-lease-seconds. Períodos de bloqueio mais curtos aceleram a recuperação do servidor, enquanto períodos mais longos são benéficos para servidores que lidam com um grande número de clientes. 
---
