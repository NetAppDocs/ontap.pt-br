...
summary: Por padrão, ONTAP realiza uma verificação adicional ao avaliar o acesso do cliente a um netgroup. Essa verificação adicional garante que o domínio do cliente corresponda à configuração de domínio da máquina virtual de storage. Caso contrário, ONTAP nega o acesso do cliente. 
---
