...
summary: Você pode exibir estatísticas LDAP para máquinas virtuais de armazenamento em um sistema de storage para monitorar o desempenho e diagnosticar problemas. 
---
