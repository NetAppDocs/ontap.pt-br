...
summary: Você pode exibir estatísticas NIS para máquinas virtuais de armazenamento no sistema de storage para monitorar o desempenho e diagnosticar problemas. 
---
