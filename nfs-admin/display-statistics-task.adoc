...
summary: Você pode exibir estatísticas NFS para máquinas virtuais de armazenamento no sistema de storage para monitorar o desempenho e diagnosticar problemas. 
---
