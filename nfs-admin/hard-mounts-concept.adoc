...
summary: Ao solucionar problemas de montagem, certifique-se de estar usando o tipo de montagem correto. NFS suporta dois tipos de montagem - montagens flexíveis e montagens rígidas. Você deve usar apenas montagens rígidas por motivos de confiabilidade. 
---
