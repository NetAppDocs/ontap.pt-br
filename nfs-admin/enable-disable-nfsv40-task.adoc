...
summary: Você pode habilitar ou desabilitar o NFSv4.0 modificando a opção -v4.0. Isso permite acesso a arquivos para clientes que utilizam o protocolo NFSv4.0. No ONTAP 9.9.1, o NFSv4.0 está habilitado por padrão. Em versões anteriores, ele está desabilitado por padrão. 
---
