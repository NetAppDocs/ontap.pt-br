...
sidebar: sidebar 
keywords:  
summary: Você pode habilitar o encaminhamento NFSv4 em máquinas virtuais de armazenamento ativando as opções -v4-fsid-change e -v4.0-referrals ou -v4.1-referrals. Habilitar o encaminhamento NFSv4 pode resultar em acesso a dados mais rápido para clientes NFSv4 que suportam esse recurso. 
---
