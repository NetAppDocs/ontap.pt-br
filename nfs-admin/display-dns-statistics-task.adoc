...
summary: Você pode exibir estatísticas de DNS para máquinas virtuais de armazenamento no sistema de storage para monitorar o desempenho e diagnosticar problemas. 
---
