...
summary: 'Você pode habilitar ou desabilitar o suporte para VMware vStorage sobre NFS em máquinas virtuais de armazenamento usando o comando `vserver nfs modify`.' 
---
