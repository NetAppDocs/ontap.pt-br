...
summary: A limpeza manual dos caches de política de exportação remove informações potencialmente desatualizadas e força ONTAP a recuperar informações atuais dos recursos externos apropriados. Isso pode ajudar a resolver diversos problemas relacionados ao acesso do cliente às exportações NFS. 
---
