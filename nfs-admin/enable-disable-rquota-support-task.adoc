...
summary: O protocolo de quota remota permite que clientes NFS obtenham informações de quota para usuários de uma máquina remota. O suporte para versões do rquota varia de acordo com a sua versão do ONTAP. 
---
