...
summary: 'ONTAP cria e mantém dois nomes para arquivos ou diretórios em qualquer diretório que tenha acesso a partir de um cliente SMB: o nome longo original e um nome no formato 8.3.' 
---
