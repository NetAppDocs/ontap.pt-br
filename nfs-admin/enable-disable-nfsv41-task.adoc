...
summary: Você pode habilitar ou desabilitar o NFSv4.1 modificando a opção -v4.1. Isso permite acesso a arquivos para clientes que utilizam o protocolo NFSv4.1. No ONTAP 9.9.1, o NFSv4.1 está habilitado por padrão. Em versões anteriores, ele está desabilitado por padrão. 
---
