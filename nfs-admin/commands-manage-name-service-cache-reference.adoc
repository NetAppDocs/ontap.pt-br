...
summary: Você pode gerenciar o cache do serviço de nomes modificando o valor de tempo de vida. O valor de TTL determina por quanto tempo as informações do serviço de nomes permanecem no cache. 
---
