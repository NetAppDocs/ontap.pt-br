...
summary: Ao habilitar o encaminhamento NFSv4, ONTAP fornece encaminhamentos intra-SVM para clientes NFSv4. O encaminhamento intra-SVM ocorre quando um nó de cluster que recebe a solicitação NFSv4 encaminha o cliente NFSv4 para outra interface lógica na máquina virtual de storage. 
---
