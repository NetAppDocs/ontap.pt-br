...
TIP: Se você estiver usando o MAV com a Proteção Autônoma contra Ransomware, defina um grupo de aprovação novo ou existente responsável por aprovar solicitações de pausa, desativação e remoção de suspeitos da proteção contra ransomware.
