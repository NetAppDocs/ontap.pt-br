...
. Novo comando protegido por regras para 9.18.1
. Novo comando protegido por regras para 9.19.1
...
* link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=storage+aggregate["agregado de armazenamento"^]
