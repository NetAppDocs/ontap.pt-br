...
summary: Você pode usar usuários e grupos UNIX locais na SVM para autenticação e mapeamento de nomes. Você pode criar usuários e grupos UNIX manualmente ou carregar um arquivo contendo usuários ou grupos UNIX a partir de um identificador uniforme de recursos. 
---
