...
summary: Se um Network Information Service for usado em seu ambiente para serviços de nomes, você deve criar uma configuração de domínio NIS para a SVM usando o comando vserver services name-service nis-domain create. 
---
