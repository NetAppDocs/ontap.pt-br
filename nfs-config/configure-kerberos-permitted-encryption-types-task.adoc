...
summary: 'Por padrão, ONTAP suporta os seguintes tipos de criptografia para NFS Kerberos: DES, 3DES, AES-128 e AES-256. Você pode configurar os tipos de criptografia permitidos para cada SVM de acordo com os requisitos de segurança do seu ambiente específico, usando o comando vserver nfs modify com o parâmetro -permitted-enc-types.' 
---
