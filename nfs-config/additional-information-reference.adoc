...
summary: Após testar com sucesso o acesso do cliente NFS, você pode realizar configurações adicionais do NFS ou adicionar acesso SAN. Quando o acesso a protocolo estiver concluído, você deve proteger o volume raiz da máquina virtual de storage. 
---
...
* https://www.netapp.com/pdf.html?item=/media/16398-tr-3580.pdf["Relatório técnico da NetApp 3580: NFSv4 melhorias e melhores práticas Guia de implementação do Data ONTAP"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16885-tr-4182.pdf["Relatório técnico da NetApp 4182: Considerações sobre o projeto de armazenamento Ethernet e práticas recomendadas para configurações de Data ONTAP em cluster"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16328-tr-4668.pdf["Relatório técnico da NetApp 4668: Guia de práticas recomendadas para serviços de nomes"^]
+
