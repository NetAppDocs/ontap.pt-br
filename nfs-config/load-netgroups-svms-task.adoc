...
summary: 'Um dos métodos que você pode usar para corresponder clientes em regras de política de exportação é utilizando hosts listados em netgroups. Você pode carregar netgroups de um identificador uniforme de recursos (URI) em SVMs como uma alternativa ao uso de netgroups armazenados em servidores de nomes externos.' 
---
