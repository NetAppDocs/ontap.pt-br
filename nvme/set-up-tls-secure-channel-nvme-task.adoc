...
summary: A partir do ONTAP 9.16.1, você pode habilitar e desabilitar o canal seguro TLS para conexões NVMe TCP. 
---
...
[role="lead"]
A partir do ONTAP 9.16.1, você pode configurar um canal seguro TLS para conexões NVMe/TCP. Você pode usar o System Manager ou a ONTAP CLI para adicionar um novo subsistema NVMe com TLS habilitado ou habilitar o TLS para um subsistema NVMe existente. A partir do ONTAP 9.19.1, o descarregamento de hardware TLS é suportado.
