...
summary: ONTAP suporta todos os principais protocolos de cliente padrão do setor, incluindo NFS, SMB, FC, FCoE, iSCSI, NVMe e S3. 
---
= Saiba mais sobre os protocolos de cliente do ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
