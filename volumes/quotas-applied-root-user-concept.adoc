...
summary: O usuário raiz em clientes UNIX está sujeito a cotas de árvore, mas não a cotas de usuário ou grupo. Isso permite que o usuário raiz execute ações em nome de outros usuários que, de outra forma, seriam impedidas por uma cota. 
---
= Saiba como as quotas do ONTAP são aplicadas ao usuário raiz
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
