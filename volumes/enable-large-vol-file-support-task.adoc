...
---
= Habilitar suporte a grandes volumes e arquivos grandes no ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Se você habilitou o suporte a grandes volumes e arquivos para um cliente NFS, o cliente deverá ser remontado para que o novo tamanho máximo de arquivo entre em vigor.
