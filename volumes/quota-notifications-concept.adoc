...
summary: As notificações de quota são mensagens enviadas ao sistema de gerenciamento de eventos e também configuradas como traps SNMP. 
---
= Notificações de cotas do ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
