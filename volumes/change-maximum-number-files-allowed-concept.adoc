...
A partir de ONTAP 9.13,1, o número máximo de inodes continua a crescer, portanto, há um inode por 32 KB de espaço de volume, mesmo que o volume seja maior que 680 GB. Este crescimento continua até que o volume atinja o máximo de inodes de 2.040.109.451.
