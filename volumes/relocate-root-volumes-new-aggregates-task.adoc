...
---
= Realocar um volume raiz do ONTAP para novos agregados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Ocorre uma reinicialização do nó durante a realocação do volume raiz, o que encerra todas as sessões SSH ativas.
