...
summary: As quotas são definidas em regras de quotas específicas para FlexVol volumes. Essas regras de quotas são reunidas em uma política de quotas para uma máquina virtual de storage e ativadas em cada volume da SVM. 
---
= Saiba mais sobre quotas do ONTAP, regras de quotas e políticas de quotas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
