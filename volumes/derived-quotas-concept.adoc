...
summary: Uma quota imposta como resultado de uma quota padrão, em vez de uma quota explícita, é denominada quota derivada. 
---
= Saiba mais sobre as quotas derivadas do ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
