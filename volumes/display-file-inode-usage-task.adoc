...
summary: Determine se você precisa aumentar o número de inodes dos seus volumes FlexVol para evitar que eles atinjam o limite de arquivos. 
---
= Determine o uso de arquivos e inodes para um volume ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
