...
summary: Mova um FlexVol volume para um agregado, nó ou ambos diferentes dentro da mesma máquina virtual de storage para equilibrar a capacidade de storage. 
---
