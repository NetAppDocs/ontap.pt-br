...
---
= Link entre o Site B e o ONTAP Mediator inativo e o Site A inativo
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Desmapear todos os LUNs pertencentes ao grupo de consistência do Site B falhará, portanto, você deve primeiro modificar o igroup para remover o SVM do par de replicação e, em seguida, excluir o mapeamento de LUN.
