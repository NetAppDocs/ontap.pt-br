...
A partir do ONTAP 9.16.1, o SnapMirror active Sync é compatível com clusters de quatro nós em configurações ativo-ativo simétricas. Você pode utilizar o cluster de quatro nós para atualizar controladores e storage.
