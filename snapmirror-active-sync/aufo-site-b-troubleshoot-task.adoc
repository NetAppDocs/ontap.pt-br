...
. Libere o grupo de consistência com `relationship-info-only` o no local A para reter a cópia Snapshot comum e desmapear os LUNs pertencentes ao grupo de consistência.
