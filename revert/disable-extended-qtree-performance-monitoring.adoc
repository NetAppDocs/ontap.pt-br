...
Você trabalha com a `ext_performance_monitoring.enabled` configuração usando o `/api/storage/qtrees` endpoint. Use GET para recuperar o valor atual, POST para defini-lo ao criar uma nova qtree e PATCH para alterá-lo em uma qtree.
