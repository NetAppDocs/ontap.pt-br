...
| ONTAP 9.18.1  a| 
* Se a capacitação automática tiver sido configurada para o ARP como parte de uma atualização do ONTAP 9.18.1, você precisará link:anti-ransomware-disable-auto-enable.html["desative-o."].
