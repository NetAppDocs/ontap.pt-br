...
+
O `-version` opção refere-se à versão do ONTAP para a qual você está revertendo.  Por exemplo, se você estiver revertendo de 9,14 para 9,13, o valor correto do `-version` a opção é 9.13.
