...
* Desative o SMB Multichannel antes de ativar o balanceamento de capacidade avançado. O uso do SMB Multichannel com o rebalanceamento de capacidade avançado pode causar alta latência. Para obter mais informações, consulte link:https://kb.netapp.com/on-prem/ontap/da/NAS/NAS-Issues/CONTAP-400433["CONTAP-400433: Alta latência de leitura/gravação ao usar FlexGroup Rebalanceamento/GDD em clientes com SMB Multichannel habilitado"^].
