...
O número mínimo de HDDs que você deve adicionar em um único procedimento é seis. O número mínimo de SSDs que você deve adicionar em um único procedimento é três. Adicionar uma unidade única pode reduzir o desempenho.
