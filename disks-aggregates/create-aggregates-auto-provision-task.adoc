...
summary: 'Você pode aceitar uma recomendação do ONTAP para adicionar um nível local automaticamente (criando um agregado com provisionamento automático) e permitir que o ONTAP adicione o nível local.' 
---
