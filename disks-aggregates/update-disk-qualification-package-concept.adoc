...
summary: 'O Pacote de Qualificação de Disco (DQP) adiciona suporte completo para unidades recém-qualificadas. Antes de atualizar o firmware da unidade ou adicionar novos tipos ou tamanhos de unidade a um cluster, você deve atualizar o DQP. Uma boa prática é também atualizar o DQP regularmente.' 
---
