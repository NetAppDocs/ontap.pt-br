...
Saiba mais sobre `storage aggregate create` opções e requisitos de criação agregados no link:https://docs.netapp.com/us-en/ontap-cli/storage-aggregate-create.html["Referência do comando ONTAP"^].
