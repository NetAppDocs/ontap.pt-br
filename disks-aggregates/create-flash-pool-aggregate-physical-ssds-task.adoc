...
---
= Criar um nível local de pool flash usando SSDs físicos no ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Passos
Você pode criar um nível local do FlashPool usando o Gerenciador de sistema ou a CLI do ONTAP.
