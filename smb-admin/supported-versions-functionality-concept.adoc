...
summary: 'O Server Message Block (SMB) é um protocolo de compartilhamento remoto de arquivos usado por clientes e servidores Microsoft Windows. Todas as versões do SMB são suportadas. Você deve verificar se o servidor SMB do ONTAP é compatível com os clientes e funcionalidades necessários em seu ambiente.' 
---
