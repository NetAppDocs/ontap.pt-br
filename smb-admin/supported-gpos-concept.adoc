...
summary: 'Embora nem todos os Objetos de Política de Grupo (GPOs) sejam aplicáveis às suas máquinas virtuais de armazenamento habilitadas para CIFS, as SVMs podem reconhecer e processar o conjunto relevante de GPOs.' 
---
