...
summary: Você pode habilitar ou desabilitar o ODX em máquinas virtuais de armazenamento. O padrão é habilitar o suporte para descarregamento de cópia ODX se o SMB 3.0 também estiver habilitado. 
---
