...
summary: O recurso Auto Location utiliza encaminhamentos automáticos de nós SMB para aumentar o desempenho do cliente SMB em máquinas virtuais de armazenamento. Os encaminhamentos automáticos de nós redirecionam automaticamente o cliente solicitante para uma LIF no nó SVM que está hospedando o volume no qual os dados residem, o que pode levar a tempos de resposta do cliente aprimorados. 
---
