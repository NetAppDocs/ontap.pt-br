...
summary: Se você não deseja que um usuário percorra todos os diretórios no caminho para um arquivo porque ele não possui permissões no diretório percorrido, você pode remover o privilégio SeChangeNotifyPrivilege dos usuários ou grupos SMB locais nas máquinas virtuais de armazenamento. 
---
