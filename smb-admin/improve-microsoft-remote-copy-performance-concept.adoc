...
summary: A Transferência de Dados Descarregada da Microsoft, também conhecida como descarregamento de cópia, permite transferências diretas de dados dentro de ou entre dispositivos de armazenamento compatíveis, sem transferir os dados pelo computador host. 
---
