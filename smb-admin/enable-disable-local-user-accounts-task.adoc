...
summary: Você habilita uma conta de usuário local se desejar que o usuário possa acessar os dados contidos na máquina virtual de storage por meio de uma conexão SMB. Você também pode desabilitar uma conta de usuário local se não desejar que esse usuário acesse os dados da SVM por meio de SMB. 
---
