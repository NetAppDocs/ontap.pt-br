...
summary: Se você configurou anteriormente BranchCache, mas não deseja que a máquina virtual de storage continue fornecendo conteúdo em cache, pode excluir a configuração do BranchCache no servidor CIFS. Você deve estar ciente do que acontece ao excluir a configuração. 
---
