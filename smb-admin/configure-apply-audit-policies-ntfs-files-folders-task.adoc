...
summary: Existem várias etapas que você deve executar para aplicar políticas de auditoria a arquivos e pastas NTFS ao usar a ONTAP CLI. Primeiro, você cria um descritor de segurança NTFS e adiciona SACLs ao descritor de segurança. Em seguida, você cria uma política de segurança e adiciona tarefas de política. Depois, você aplica a política de segurança a uma máquina virtual de storage. 
---
