...
summary: Você pode exibir informações detalhadas sobre as políticas de acesso central definidas no Active Directory. Você também pode exibir informações sobre as políticas de acesso central aplicadas ao servidor CIFS por meio de objetos de política de grupo. 
---
