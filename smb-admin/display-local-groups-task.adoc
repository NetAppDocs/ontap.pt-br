...
summary: Você pode exibir uma lista de todos os grupos locais configurados no cluster ou em uma máquina virtual de storage especificada. Essas informações podem ser úteis para solucionar problemas de acesso a arquivos contidos na SVM ou problemas de direitos de usuário na SVM. 
---
