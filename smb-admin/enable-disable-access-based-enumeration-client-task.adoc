...
summary: Você pode habilitar ou desabilitar a enumeração baseada em acesso em compartilhamentos SMB a partir de um cliente Windows, o que permite configurar essa opção de compartilhamento sem precisar se conectar ao servidor CIFS. 
---
