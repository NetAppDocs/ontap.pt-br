...
summary: 'ONTAP BranchCache oferece suporte a Objetos de Política de Grupo (BranchCache GPOs), que permitem o gerenciamento centralizado de determinados parâmetros de configuração do BranchCache. Existem dois GPOs usados para BranchCache: o GPO de Publicação de Hash para BranchCache e o GPO de Suporte à Versão de Hash para BranchCache.' 
---
