...
summary: Você configura o estilo de segurança do volume FlexVol para determinar o tipo de permissões usadas para dados nos volumes FlexVol da máquina virtual de storage. 
---
