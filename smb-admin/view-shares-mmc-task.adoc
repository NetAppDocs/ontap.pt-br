...
summary: Você pode visualizar informações sobre compartilhamentos SMB em sua SVM e executar algumas tarefas de gerenciamento usando o Microsoft Management Console. Antes de visualizar os compartilhamentos, você precisa conectar o MMC à SVM. 
---
