...
summary: Você pode habilitar ou desabilitar usuários e grupos locais para acesso SMB em máquinas virtuais de armazenamento. A funcionalidade de usuários e grupos locais está habilitada por padrão. 
---
