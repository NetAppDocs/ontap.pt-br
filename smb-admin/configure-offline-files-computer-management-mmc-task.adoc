...
summary: Se você deseja permitir que os usuários armazenem arquivos em cache localmente para uso offline, pode configurar o suporte a arquivos offline usando o MMC de Gerenciamento do Computador. 
---
