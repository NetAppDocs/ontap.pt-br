...
summary: Você pode exibir uma lista de todos os membros dos grupos locais configurados no cluster ou em uma máquina virtual de storage especificada. Essas informações podem ser úteis para solucionar problemas de acesso a arquivos ou de direitos de usuário. 
---
