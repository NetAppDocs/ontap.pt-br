...
summary: ONTAP suporta o armazenamento de perfis móveis do Windows em um servidor CIFS associado à máquina virtual de storage. Configurar perfis móveis de usuário oferece vantagens ao usuário, como a disponibilidade automática de recursos independentemente de onde o usuário faça login. Os perfis móveis também simplificam a administração e o gerenciamento de perfis de usuário. 
---
