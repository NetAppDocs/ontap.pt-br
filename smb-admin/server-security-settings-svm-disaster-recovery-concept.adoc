...
summary: Antes de criar uma SVM configurada como destino de recuperação de desastres onde a identidade não é preservada, você deve saber como as configurações de segurança do servidor SMB são gerenciadas na SVM de destino. 
---
