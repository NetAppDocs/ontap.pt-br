...
summary: Se a sua configuração BranchCache ativar automaticamente o armazenamento em cache em todos os compartilhamentos SMB em cada máquina virtual de storage, você pode modificar a configuração BranchCache para interromper o armazenamento em cache de conteúdo para todos os compartilhamentos SMB. 
---
