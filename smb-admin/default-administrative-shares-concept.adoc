...
summary: Ao criar um servidor CIFS em sua máquina virtual de storage, compartilhamentos administrativos padrão são criados automaticamente. É importante entender o que são esses compartilhamentos padrão e como eles são usados. 
---
