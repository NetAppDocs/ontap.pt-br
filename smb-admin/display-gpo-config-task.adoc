...
summary: 'Você pode exibir informações sobre as configurações de Objetos de Política de Grupo (GPOs) definidas no Active Directory e sobre as configurações de GPO aplicadas ao servidor CIFS.' 
---
