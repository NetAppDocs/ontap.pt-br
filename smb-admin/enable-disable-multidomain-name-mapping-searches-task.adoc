...
summary: Com as pesquisas de mapeamento de nomes em vários domínios, você pode usar um caractere curinga na parte do domínio de um nome do Windows ao configurar o mapeamento de nome de usuário UNIX para nome de usuário do Windows. O uso de um caractere curinga na parte do domínio do nome permite que o ONTAP pesquise todos os domínios que possuem uma relação de confiança bidirecional com o domínio que contém a conta de computador do servidor CIFS. 
---
