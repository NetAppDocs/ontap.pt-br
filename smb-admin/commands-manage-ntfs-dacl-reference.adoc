...
summary: Existem comandos ONTAP específicos para gerenciar entradas de controle de acesso DACL. Você pode adicionar ACEs a DACLs NTFS a qualquer momento. Você também pode gerenciar DACLs NTFS existentes, modificando, excluindo e exibindo informações sobre ACEs nas DACLs. 
---
