...
summary: Você pode exibir informações sobre as configurações do BranchCache em máquinas virtuais de armazenamento, o que pode ser útil para verificar uma configuração ou para determinar as configurações atuais antes de modificá-la. 
---
