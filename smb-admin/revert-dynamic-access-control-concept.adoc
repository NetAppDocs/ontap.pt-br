...
summary: Você deve estar ciente do que acontece ao reverter para uma versão do ONTAP que não oferece suporte ao Controle de Acesso Dinâmico e o que você deve fazer antes e depois da reversão. 
---
