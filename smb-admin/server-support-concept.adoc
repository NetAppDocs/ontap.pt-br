...
summary: Você pode habilitar e configurar servidores SMB em máquinas virtuais de armazenamento para permitir que clientes SMB acessem arquivos em seu cluster. 
---
