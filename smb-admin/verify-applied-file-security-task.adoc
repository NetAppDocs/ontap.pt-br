...
summary: 'Você pode verificar as configurações de segurança do arquivo para confirmar se os arquivos ou pastas na máquina virtual de armazenamento (SVM) à qual você aplicou a diretiva de segurança têm as configurações desejadas.' 
---
= Verifique a segurança do arquivo ONTAP SMB
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Passo
. Exibir configurações de segurança de arquivos e pastas: `vserver security file-directory show -vserver vserver_name -path path [-expand-mask true]`
+
