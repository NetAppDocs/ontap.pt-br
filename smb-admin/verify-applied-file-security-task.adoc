...
summary: Você pode verificar as configurações de segurança de arquivos para confirmar se os arquivos ou pastas na máquina virtual de storage à qual você aplicou a política de segurança possuem as configurações desejadas. 
---
