...
summary: Os oplocks permitem que os clientes bloqueiem arquivos e armazenem conteúdo em cache localmente, o que pode aumentar o desempenho das operações com arquivos. Os oplocks são habilitados em compartilhamentos SMB residentes em máquinas virtuais de armazenamento. Em algumas circunstâncias, você pode querer desabilitar os oplocks. Você pode habilitar ou desabilitar os oplocks em cada compartilhamento individualmente. 
---
