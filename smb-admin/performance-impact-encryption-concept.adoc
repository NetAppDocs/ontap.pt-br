...
summary: Quando as sessões SMB usam criptografia SMB, todas as comunicações SMB de e para clientes Windows sofrem um impacto no desempenho, o que afeta tanto os clientes quanto o servidor. 
---
