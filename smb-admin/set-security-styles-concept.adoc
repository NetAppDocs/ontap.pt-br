...
summary: É possível definir estilos de segurança em volumes e qtrees FlexVol. Esses estilos podem ser definidos manualmente no momento da criação, herdados automaticamente ou alterados posteriormente. 
---
