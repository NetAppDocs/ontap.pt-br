...
summary: Você pode excluir contas de usuário locais da sua máquina virtual de storage se elas não forem mais necessárias para autenticação SMB local no servidor CIFS ou para determinar os direitos de acesso aos dados contidos na sua SVM. 
---
