...
summary: Existem algumas considerações que você deve ter em mente ao usar o Dynamic Access Control e políticas de acesso central para proteger arquivos e pastas em servidores CIFS. 
---
