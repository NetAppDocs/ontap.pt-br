...
summary: Os nomes de compartilhamento do diretório base devem conter o nome de usuário do Windows ou a variável dinâmica de nome de usuário do UNIX. Você deve estar ciente do que acontece com os nomes de compartilhamento estáticos existentes do diretório base após a atualização para uma versão do ONTAP com esse novo requisito. 
---
