...
summary: Você pode excluir um grupo local da máquina virtual de armazenamento se ele não for mais necessário para determinar os direitos de acesso aos dados associados a essa máquina virtual de armazenamento ou se não for mais necessário para atribuir direitos de usuário da máquina virtual de armazenamento aos membros do grupo. 
---
