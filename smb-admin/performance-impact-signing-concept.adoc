...
summary: Quando as sessões SMB utilizam a assinatura SMB, todas as comunicações SMB de e para clientes Windows sofrem um impacto no desempenho, afetando tanto os clientes quanto o servidor. 
---
