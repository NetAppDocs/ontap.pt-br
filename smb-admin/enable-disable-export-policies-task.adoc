...
summary: Você pode habilitar ou desabilitar políticas de exportação para acesso SMB em máquinas virtuais de armazenamento. O uso de políticas de exportação para controlar o acesso SMB aos recursos é opcional. 
---
