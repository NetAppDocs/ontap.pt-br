...
summary: Você pode gerenciar a segurança de arquivos NTFS, as políticas de auditoria NTFS e o Storage-Level Access Guard em máquinas virtuais de armazenamento usando a CLI. 
---
