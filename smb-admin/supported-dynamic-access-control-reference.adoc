...
summary: Se você deseja usar o Controle de Acesso Dinâmico em seu servidor CIFS, precisa entender como ONTAP oferece suporte à funcionalidade de Controle de Acesso Dinâmico em ambientes do Active Directory. 
---
