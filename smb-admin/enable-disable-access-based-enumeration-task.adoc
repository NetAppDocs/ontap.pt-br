...
summary: Você pode habilitar ou desabilitar a enumeração baseada em acesso em compartilhamentos SMB para permitir ou impedir que os usuários vejam recursos compartilhados aos quais não têm permissão de acesso. 
---
