...
summary: Você pode exibir informações detalhadas sobre grupos restritos definidos como Objetos de Política de Grupo no Active Directory e que são aplicados ao servidor CIFS. 
---
