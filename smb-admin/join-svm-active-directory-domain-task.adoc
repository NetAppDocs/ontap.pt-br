...
summary: Você pode adicionar uma máquina virtual de storage a um domínio do Active Directory sem excluir o servidor SMB existente, modificando o domínio com o comando vserver cifs modify. Você pode retornar ao domínio atual ou ingressar em um novo. 
---
