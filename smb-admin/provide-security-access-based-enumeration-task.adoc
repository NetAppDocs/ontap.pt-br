...
summary: Quando a enumeração baseada em acesso está habilitada em um compartilhamento SMB, os usuários que não têm permissão para acessar uma pasta ou arquivo contido no compartilhamento não veem esse recurso compartilhado exibido em seu ambiente. 
---
