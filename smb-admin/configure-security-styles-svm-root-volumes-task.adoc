...
summary: Você configura o estilo de segurança do volume raiz da máquina virtual de storage para determinar o tipo de permissões usadas para os dados no volume raiz da SVM. 
---
