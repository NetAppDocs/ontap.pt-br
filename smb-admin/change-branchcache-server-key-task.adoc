...
summary: Você pode alterar a chave do servidor BranchCache modificando a configuração BranchCache na máquina virtual de storage e especificando uma chave de servidor diferente. 
---
