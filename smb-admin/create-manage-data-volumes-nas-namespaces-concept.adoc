...
summary: Para gerenciar o acesso a arquivos em um ambiente NAS, você deve gerenciar volumes de dados e pontos de junção em sua máquina virtual de storage. Isso inclui planejar a arquitetura do seu namespace, criar volumes com ou sem pontos de junção, montar ou desmontar volumes e exibir informações sobre volumes de dados e namespaces de servidor NFS ou servidor CIFS. 
---
