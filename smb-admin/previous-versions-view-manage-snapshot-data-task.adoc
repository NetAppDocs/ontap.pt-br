...
summary: Usuários em máquinas cliente Windows podem usar a guia Versões Anteriores na janela Propriedades do Windows para restaurar dados armazenados em snapshots sem precisar envolver o administrador da máquina virtual de armazenamento. 
---
