...
summary: Por padrão, um usuário anônimo e não autenticado pode acessar determinadas informações na rede. Você pode usar uma opção do servidor SMB para configurar restrições de acesso para o usuário anônimo. 
---
