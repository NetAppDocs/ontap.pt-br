...
summary: Adicionar entradas de controle de acesso DACL ao descritor de segurança NTFS é o segundo passo na configuração e aplicação de ACLs NTFS a um arquivo ou pasta. Cada entrada identifica qual objeto tem permissão ou acesso negado e define o que o objeto pode ou não fazer com os arquivos ou pastas definidos na ACE. 
---
