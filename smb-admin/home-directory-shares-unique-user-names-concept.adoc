...
summary: Tenha cuidado ao atribuir nomes de usuário exclusivos ao criar compartilhamentos de diretório base usando as variáveis de nome de usuário do Windows ou do UNIX para gerar compartilhamentos dinamicamente. O nome do compartilhamento é mapeado para o seu nome de usuário. 
---
