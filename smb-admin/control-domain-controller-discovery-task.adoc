...
summary: A partir do ONTAP 9.3, você pode modificar o processo padrão pelo qual os controladores de domínio são descobertos. Isso permite limitar a descoberta ao seu site ou a um conjunto de controladores de domínio preferenciais, o que pode levar a melhorias de desempenho dependendo do ambiente. 
---
