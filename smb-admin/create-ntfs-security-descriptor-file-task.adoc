...
summary: Criar um descritor de segurança NTFS é o primeiro passo para configurar e aplicar listas de controle de acesso NTFS a arquivos e pastas residentes em máquinas virtuais de armazenamento. Você pode associar o descritor de segurança ao caminho do arquivo ou pasta em uma tarefa de política. 
---
