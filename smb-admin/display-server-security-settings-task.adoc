...
summary: Você pode exibir informações sobre as configurações de segurança do servidor SMB em suas máquinas virtuais de armazenamento. Você pode usar essas informações para verificar se as configurações de segurança estão corretas. 
---
