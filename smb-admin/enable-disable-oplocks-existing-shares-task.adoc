...
summary: 'Por padrão, os bloqueios operacionais (oplocks) estão habilitados em compartilhamentos SMB em máquinas virtuais de armazenamento. Em algumas circunstâncias, você pode querer desabilitar os oplocks. Alternativamente, se você já desabilitou os oplocks em um compartilhamento, pode querer habilitá-los novamente.' 
---
