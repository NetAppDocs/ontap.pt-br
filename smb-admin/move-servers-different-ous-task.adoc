...
summary: O processo de criação do servidor CIFS usa a unidade organizacional padrão CN-Computers durante a configuração, a menos que você especifique uma unidade organizacional diferente. Você pode mover servidores CIFS para unidades organizacionais diferentes após a configuração. 
---
