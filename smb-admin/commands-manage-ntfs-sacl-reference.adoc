...
summary: Existem comandos ONTAP específicos para gerenciar entradas de controle de acesso SACL. Você pode adicionar ACEs a SACLs NTFS a qualquer momento. Você também pode gerenciar SACLs NTFS existentes, modificando, excluindo e exibindo informações sobre ACEs nas SACLs. 
---
