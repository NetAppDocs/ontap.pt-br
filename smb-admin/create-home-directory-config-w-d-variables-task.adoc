...
summary: Você pode criar uma configuração de diretório base usando o nome de usuário do Windows e as variáveis de diretório base. Os usuários podem então se conectar ao seu compartilhamento pessoal usando compartilhamentos criados dinamicamente. 
---
