...
summary: Você pode exibir informações sobre o tipo de usuário conectado por meio de sessões SMB. Isso pode ajudar a garantir que apenas o tipo de usuário apropriado esteja se conectando por meio de sessões SMB na máquina virtual de storage. 
---
