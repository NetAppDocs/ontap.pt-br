...
summary: Criar uma política de auditoria de descritor de segurança NTFS é o primeiro passo para configurar e aplicar listas de controle de acesso NTFS a arquivos e pastas residentes em SVMs. Você associará o descritor de segurança ao caminho do arquivo ou pasta em uma tarefa de política. 
---
