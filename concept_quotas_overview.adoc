...
---
= Aprenda sobre gerenciamento de cotas com o ONTAP System Manager
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
* link:http://docs.netapp.com/us-en/ontap-system-manager-classic/online-help-96-97/index.html["Documentação do ONTAP 9.7 e 9.6"^]
