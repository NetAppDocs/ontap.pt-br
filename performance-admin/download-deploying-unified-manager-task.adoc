...
summary: Para instalar o software, você deve baixar o arquivo de instalação do appliance virtual e, em seguida, usar um VMware vSphere Client para implantar o arquivo em um servidor VMware ESXi. O VA está disponível em um arquivo OVA. 
---
