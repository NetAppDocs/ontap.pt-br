...
* Volumes de origem do FlexCache
+
Suportado a partir do ONTAP 9.16.1.

* SnapMirror síncrono
+
A partir do ONTAP 9.19.1, você só pode especificar o tempo de expiração durante a criação do snapshot. Não é possível definir ou estender o tempo de expiração em snapshots existentes.
