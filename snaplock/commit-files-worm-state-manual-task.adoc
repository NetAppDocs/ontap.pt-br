...
summary: Você pode adicionar arquivos ao WORM manualmente ou por meio de commit automático. Você também pode criar arquivos WORM anexáveis. 
---
= Enviar arquivos para WORM usando ONTAP SnapLock
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
