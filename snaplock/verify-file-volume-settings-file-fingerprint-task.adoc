...
summary: 'Você pode usar os comandos `volume file fingerprint start` e `volume file fingerprint dump` para visualizar informações importantes sobre arquivos e volumes, incluindo o tipo de arquivo, a data de expiração do volume e assim por diante.' 
---
= Verificar as configurações do ONTAP SnapLock
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
