...
+
Por exemplo, você pode usar o caminho de atualização direta da versão 9.12.1 para a 9.13.1 ou da 9.13.1 para a 9.17.1.
...
+
Por exemplo, se você estiver executando a versão 9.8 e quiser atualizar para a versão 9.16.1, deverá concluir uma atualização em várias etapas: primeiro da versão 9.8 para a 9.12.1 e, em seguida, da 9.12.1 para a 9.16.1.  As atualizações de versões anteriores podem exigir três ou mais etapas, com várias atualizações intermediárias.
...
=== A partir do ONTAP 9.8 e versões posteriores

As atualizações automatizadas e manuais do ONTAP 9.8 e versões posteriores seguem os mesmos caminhos de atualização.

.A partir do ONTAP 9.15.1 e versões posteriores
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.15.1 e versões posteriores para atualizações automatizadas e manuais.
...
| 9.18.1 | 9.19.1 | direta 


.2+| 9.17.1 | 9.19.1 | direta 


| 9.18.1 | direta 


.3+| 9.16.1 | 9.19.1 | direta 
...
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.14.1 para atualizações automatizadas e manuais.
...
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.13.1 para atualizações automatizadas e manuais.
...
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.12.1 para atualizações automatizadas e manuais.
...
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.11.1 para atualizações automatizadas e manuais.
...
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.10.1 para atualizações automatizadas e manuais.
...
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.9.1 para atualizações automatizadas e manuais.
...
[%collapsible]
====
Os seguintes caminhos de atualização são suportados a partir do ONTAP 9.8 para atualizações automatizadas e manuais.
...
Para ONTAP 9.7 e 9.6, os caminhos de atualização automática e manual podem variar dependendo da versão de destino do ONTAP.

.A partir de ONTAP 9.7
[%collapsible]
====
O caminho de atualização manual do ONTAP 9.7 para as versões 9.10.1 e 9.11.1 varia do caminho de atualização automatizado. Essas variações estão indicadas na tabela abaixo. Para atualizações do ONTAP 9.7 para todas as outras versões do ONTAP, as atualizações automáticas e manuais seguem o mesmo caminho de atualização.
...
| 9.11.1  a| 
* Caminho de atualização automatizado
+
multi-hop direto (requer imagens para 9,8 e 9.11.1)

* Caminho de atualização manual
+
multi-estágio
...
[%collapsible]
====
O caminho de atualização manual do ONTAP 9.6 para o 9.10.1 difere do caminho de atualização automatizado. Essa diferença está indicada na tabela abaixo. Para atualizações do ONTAP 9.6 para todas as outras versões do ONTAP, as atualizações automáticas e manuais seguem o mesmo caminho de atualização.
...
Os caminhos de atualização do ONTAP 9.5 variam dependendo se você está realizando uma atualização automatizada ou manual.

.Caminhos de atualização automatizados
[%collapsible]
====
Utilize os seguintes caminhos de atualização para atualizações automatizadas a partir de ONTAP 9.5.
...
[%collapsible]
====
Utilize os seguintes caminhos de atualização para atualizações manuais a partir de ONTAP 9.5
...
Os caminhos de atualização do ONTAP 9.4, 9.3, 9.2, 9.1 e 9.0 variam dependendo se você está realizando uma atualização automatizada ou manual.

.Caminhos de atualização automatizados
[%collapsible]
====
Utilize os seguintes caminhos de atualização para atualizações automatizadas do ONTAP 9.4, 9.3, 9.2, 9.1 e 9.0.
...
[%collapsible]
====
Utilize os seguintes caminhos de atualização para atualizações manuais a partir de ONTAP 9.4, 9.3, 9.2, 9.1 e 9.0.
