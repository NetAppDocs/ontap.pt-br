...
---
= Atualize uma configuração de dois nós do ONTAP MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Se você tiver uma configuração de dois nós MetroCluster executando ONTAP 9.3 ou posterior, use as etapas da CLI em link:automated-upgrade-task.html["Instale a imagem ONTAP com a atualização automática do ONTAP sem interrupções"].
