...
summary: Antes de atualizar o ONTAP, responda a quaisquer avisos de atividade anormal no ARP. 
---
= Resolva os avisos de atividade ARP antes de uma atualização do ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
