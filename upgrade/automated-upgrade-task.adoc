...
+
<<<<<<< HEAD Para FTP anônimo, você deve especificar a URL no formato +ftp://anonymous@ftpserver+.



[]
=====
Para FTP anônimo, você deve especificar a URL no formato \ftp://anonymous@ftpserver. >>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
