...
. Consulte as seções _Precauções de atualização_ e _Problemas e limitações conhecidos_ na link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2492508["ONTAP 9 Notas de versão"^] para a versão desejada.
+
