...
---
= Compatibilidade da versão do ONTAP para clusters com versões mistas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
| 9.17.1 | 9.18.1 | Suportado 


.2+| 9.16.1 | 9.18.1 | Suportado 


| 9.17.1 | Suportado 


.3+| 9.15.1 | 9.18.1 | Suportado 
...
.5+| 9.12.1 | 9.17.1 ou posterior | Não suportado 
...
.5+| 9.11.1 | 9.16.1 ou posterior  a| 
Não suportado
...
.5+| 9.10.1 | 9.15.1 ou posterior  a| 
Não suportado
