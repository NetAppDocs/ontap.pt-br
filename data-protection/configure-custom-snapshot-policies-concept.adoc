...
summary: Uma política de instantâneos define como o sistema cria instantâneos. A política especifica quando criar instantâneos, quantas cópias manter e como nomeá-las. 
---
