...
+
Se o seu sistema foi adquirido antes de junho de 2019 com um pacote Premium ou Flash, você pode baixar uma chave da licença da NetApp para obter a licença síncrona necessária do SnapMirror no site de suporte da NetApp: https://mysupport.netapp.com/NOW/knowledge/docs/olio/guides/master_lickey/["Chaves de licença"^].
