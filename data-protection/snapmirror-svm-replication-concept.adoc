...
** A associação de volumes com políticas de snapshot definidas pelo usuário e pelo sistema não é copiada para o destino SVM.
...
Ativar IPsec
 a| 
Não é compatível a partir de ONTAP 9.19.1.
