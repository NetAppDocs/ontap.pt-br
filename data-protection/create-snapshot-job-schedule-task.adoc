...
summary: Uma política Snapshot requer pelo menos um agendamento de trabalho de cópia Snapshot. Use o System Manager ou o comando cron create da programação de trabalho para criar uma agenda de trabalho. 
---
