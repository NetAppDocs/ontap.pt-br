...
* link:convert-exclude-svm-replication-task.html["Converter uma relação de replicação SVM do ONTAP SnapMirror para incluir informações de configuração da SVM"]
