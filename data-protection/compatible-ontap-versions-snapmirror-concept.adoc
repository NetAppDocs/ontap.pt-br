...
* Você pode usar o SVM DR para migrar um SVM que não atenda às restrições indicadas para link:../svm-migrate/index.html["Migração de SVM (mobilidade de dados SVM)"].
