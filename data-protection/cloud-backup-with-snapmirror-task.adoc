...
[role="lead"]
A partir do ONTAP 9.9.1, você pode usar o _SnapMirror cloud_ quando desejar migrar seus fluxos de trabalho de proteção de dados para a nuvem. Em vez de arquiteturas legadas de backup em fita, você pode usar storage de objetos como um repositório alternativo para retenção de dados e arquivamento a longo prazo. Você pode usar provedores como Amazon S3, Alibaba Cloud, Azure Blob, Google Cloud Storage, IBM Cloud Object Storage, StorageGRID ou ONTAP S3 como seu armazenamento de objetos na nuvem.

A partir do ONTAP 9.9.1, você pode usar System Manager para fazer backup e restaurar seus dados.
