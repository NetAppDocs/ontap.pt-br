...
* O backup em nuvem do SnapMirror dá suporte a relacionamentos de fanout. Isso significa que os backups do SnapMirror podem ser criados simultaneamente em dois armazenamentos de objetos diferentes.
