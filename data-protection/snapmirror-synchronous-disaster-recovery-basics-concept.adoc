...
| Proteção autônoma contra ransomware | ONTAP 9.19.1 | Se você habilitar o ARP em volumes que fazem parte de SnapMirror síncronos ou de SnapMirror sincronização ativa após a atualização, o relacionamento entrará brevemente em um estado de dessincronização. Essa condição é temporária e o relacionamento deverá ressincronizar automaticamente sem intervenção. 
