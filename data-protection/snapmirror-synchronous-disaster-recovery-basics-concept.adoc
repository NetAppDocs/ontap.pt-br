...
| Proteção autônoma contra ransomware | ONTAP 9.19.1 | Após a atualização para ONTAP 9.19.1 RC e a ativação do ARP, o relacionamento pode apresentar um breve estado de dessincronização. Essa condição é temporária e o relacionamento deve se ressincronizar automaticamente sem qualquer intervenção. 
