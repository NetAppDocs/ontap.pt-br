...
| Proteção autônoma contra ransomware | ONTAP 9.19.1 | Após a atualização para ONTAP 9.19.1 RC e a ativação do ARP em volumes que fazem parte de relacionamentos síncronos do SnapMirror, o relacionamento pode apresentar um breve estado de dessincronização. Essa condição é temporária e o relacionamento deve ressincronizar automaticamente sem qualquer intervenção. 
