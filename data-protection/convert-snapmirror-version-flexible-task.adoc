...
---
= Converta uma relação de tipo DP existente para XDP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Você pode achar útil manter uma cópia da `snapmirror show` saída do comando para manter o controle existente das configurações de relacionamento.
...
----
+
Para obter a sintaxe de comando completa, consulte link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-quiesce.html["página de manual"^].
...
----
+
Para obter a sintaxe de comando completa, consulte link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-break.html["página de manual"^].
...
----
+
Para obter a sintaxe de comando completa, consulte link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-delete.html["página de manual"^].
...
----
+
O novo relacionamento deve usar o mesmo volume de origem e destino. Para obter a sintaxe completa do comando, consulte a página man.
...
----
+
Para melhorar o tempo de ressincronização, você pode usar a `-quick-resync` opção, mas deve estar ciente de que a economia com eficiência de storage pode ser perdida. Para obter a sintaxe completa do comando, consulte a página man: link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-resync.html#parameters.html["Comando ressincronizar SnapMirror"^].
