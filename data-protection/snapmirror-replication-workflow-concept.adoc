...
summary: Para cada tipo de relação de proteção de dados SnapMirror, o fluxo de trabalho é o mesmo. Você cria um volume de destino, cria um agendamento de tarefas, especifica uma política, cria e inicializa a relação. 
---
