...
summary: Uma política de instantâneos especifica quando criar instantâneos, quantas cópias manter e como nomeá-las. Uma política de instantâneos pode conter até cinco agendamentos de tarefas. 
---
