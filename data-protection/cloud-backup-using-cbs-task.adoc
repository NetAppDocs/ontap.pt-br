...
.Passos
. No Gerenciador do sistema, clique em *proteção > Visão geral* e, em seguida, role até a seção *Backup e recuperação do BlueXP *.
...
. Clique em *conetar e habilite o backup e a recuperação do BlueXP *.
