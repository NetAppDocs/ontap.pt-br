...
NOTE: O Cloud Backup é compatível com volumes de leitura-gravação FlexVol e volumes de proteção de dados (DP). O FlexGroup volumes e o SnapLock volumes não são compatíveis.
