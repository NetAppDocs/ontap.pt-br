...
. link:https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-netapp-accounts.html["Gere uma chave de acesso e uma chave secreta usando o BlueXP "^].
