...
NOTE: Para ignorar a verificação automática de assinatura durante a instalação, use o seguinte comando: `./ontap-mediator-1.9.0/ontap-mediator-1.9.0 -y --skip-code-signature-check`
