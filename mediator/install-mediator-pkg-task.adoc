...
[CAUTION]
====
* Em configurações IP do MetroCluster, quando o ONTAP Mediator está configurado com o protocolo HTTPS, uma única instância do ONTAP Mediator só pode monitorar uma configuração IP do MetroCluster. O monitoramento simultâneo de várias configurações de IP MetroCluster não é suportado.
