...
NOTE: Para pular a verificação automática de assinatura durante a instalação, use o seguinte comando:  `./ontap-mediator-1.10/ontap-mediator-1.10 -y --skip-code-signature-check`
