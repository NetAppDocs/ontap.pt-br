...
Se a VM que executa o ONTAP Mediator precisar ser atualizada com um kernel mais novo, isso poderá causar problemas de compatibilidade com os módulos do kernel SCST usados pelo ONTAP Mediator. Nesse cenário, a NetApp recomenda que você desinstale e reinstale manualmente o SCST.



=== Etapa 1: desinstalar manualmente o SCST
...
=== Etapa 2: instalar manualmente o SCST
...
NOTE: Se estiver realizando uma instalação pela primeira vez e quiser pré-instalar o SCST antes de instalar o ONTAP Mediator, você pode pular esta etapa. O instalador do ONTAP Mediator aplica quaisquer patches relevantes aos componentes do SCST durante a instalação.
