...
`ontap-mediator-1.8.0`
 a| 
O executável de instalação do produto para a versão 1.8.0
...
----
. Verifique os `ontap-mediator-1.8.0.sig.tsr` arquivos e `ontap-mediator-1.8.0.tsr` usando os certificados associados:
+
`openssl ts -verify`
