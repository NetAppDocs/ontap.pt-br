...
[NOTE]
====
* A partir de 15 de junho de 2025, você não poderá instalar ou atualizar para o ONTAP Mediator 1.9 e 1.8 porque os certificados de verificação de assinatura de código expiraram. Em vez disso, instale ou atualize para o ONTAP Mediator 1.10.
