...
`ontap-mediator-1.12.0`
 a| 
O executável de instalação para a versão 1.12
...
----
. Verifique os  `ontap-mediator-1.12.0.sig.tsr` e  `ontap-mediator-1.12.0.tsr` arquivos usando os certificados associados:
+
[role="tabbed-block"]
====
.OpenSSL 3.x
