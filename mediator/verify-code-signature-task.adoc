...
NOTE: Se o sistema não atender aos requisitos abaixo, o processo de verificação não é necessário e você pode ir diretamente para link:install-mediator-pkg-task.html["Instale o pacote de instalação do Mediador ONTAP"].
