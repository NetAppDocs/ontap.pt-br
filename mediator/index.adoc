...
+
** 31784: Configure esta porta para solicitações de entrada porque é uma porta HTTPS e aceita apenas tráfego de entrada.
** 3260: Esta porta é bidirecional porque o protocolo iSCSI requer uma conexão bidirecional.
