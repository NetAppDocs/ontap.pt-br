...
.Procedimento para sistema operacional Oracle Linux 10.x
[#OL10x%collapsible]
====
Utilize este procedimento se o seu sistema operacional for *Oracle Linux 10.x* para habilitar o acesso aos repositórios:
...
====
.Procedimento para sistema operacional Oracle Linux 9.x
[#OL9x%collapsible]
====
Utilize este procedimento se o seu sistema operacional for *Oracle Linux 9.x* para habilitar o acesso aos repositórios:
