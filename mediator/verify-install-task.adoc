...
summary: Após a instalação do ONTAP Mediator, você deve verificar se ele está em execução. 
---
= Verifique o status da instalação do Mediador ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Se você instalou ONTAP Mediator 1.12 ou posterior com suporte apenas para HTTPS, o pacote SCST não está instalado e você pode ignorar esta etapa.
