...
summary: Você pode optar por executar operações de backup em fita e restauração de fita no nível do nó ou no nível da máquina virtual de armazenamento. Para executar essas operações com sucesso no nível da SVM, o serviço NDMP deve estar habilitado na SVM. 
---
