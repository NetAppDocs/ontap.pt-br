...
summary: O CAB é uma extensão do protocolo NDMP v4. Essa extensão permite que o servidor NDMP estabeleça uma conexão de dados em um nó que possui um volume. Isso também permite que o aplicativo de backup determine se volumes e dispositivos de fita estão localizados no mesmo nó em um cluster. 
---
