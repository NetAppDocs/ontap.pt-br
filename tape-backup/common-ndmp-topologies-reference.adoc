...
summary: O NDMP suporta diversas topologias e configurações entre aplicativos de backup e sistemas de storage ou outros servidores NDMP que fornecem serviços de dados e fita. 
---
