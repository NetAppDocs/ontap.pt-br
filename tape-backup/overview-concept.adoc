...
summary: ONTAP suporta backup em fita e restauração em fita através do Network Data Management Protocol. NDMP permite fazer backup de dados em sistemas de storage diretamente para fita, resultando em uso eficiente da largura de banda. ONTAP suporta tanto os mecanismos dump quanto SMTape para backup em fita. 
---
