...
summary: 'ONTAP suporta dois mecanismos de backup: SMTape e dump. Você deve conhecer os casos de uso dos mecanismos de backup SMTape e dump para ajudar a escolher o mecanismo de backup para realizar operações de backup em fita e restauração.' 
---
