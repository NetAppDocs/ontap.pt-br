...
summary: O número máximo de threads de entrada e saída de fita locais ativas está atualmente em uso. Você pode ter no máximo 16 unidades de fita locais ativas. 
---
