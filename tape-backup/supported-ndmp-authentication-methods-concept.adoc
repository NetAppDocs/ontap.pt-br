...
summary: Você pode especificar um método de autenticação para permitir solicitações de conexão NDMP. ONTAP oferece suporte a dois métodos para autenticar o acesso NDMP a um sistema de storage - texto simples e desafio. 
---
