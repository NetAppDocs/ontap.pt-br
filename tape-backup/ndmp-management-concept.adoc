...
summary: 'O Network Data Management Protocol (NDMP) é um protocolo padronizado para controlar backup, recuperação e outros tipos de transferência de dados entre dispositivos de storage primário e secundário, como sistemas de storage e bibliotecas de fitas.' 
---
