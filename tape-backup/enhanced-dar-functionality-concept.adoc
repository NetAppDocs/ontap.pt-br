...
summary: Você pode usar a funcionalidade de recuperação de acesso direto aprimorada para DAR de diretórios e DAR de arquivos e fluxos NT. Por padrão, a funcionalidade DAR aprimorada está habilitada. 
---
