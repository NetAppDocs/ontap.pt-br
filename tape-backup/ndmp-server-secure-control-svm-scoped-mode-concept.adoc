...
summary: Uma conexão de controle segura pode ser estabelecida entre o Aplicativo de Gerenciamento de Dados e o servidor NDMP usando sockets seguros como mecanismo de comunicação. Essa comunicação SSL é baseada nos certificados do servidor. 
---
