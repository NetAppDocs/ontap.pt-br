...
summary: Ao realizar operações de backup e restauração de SMTape por meio de NDMP ou CLI, é preciso estar ciente do número máximo de sessões de backup e restauração de SMTape que podem ser executadas simultaneamente em sistemas de storage com diferentes capacidades de memória do sistema. Esse número máximo depende da memória do sistema de storage. 
---
