...
summary: Criar várias cópias de dados regulamentados oferece cenários de recuperação redundantes e, usando o NDMP dump e restore, é possível preservar as características de gravar uma vez, ler várias vezes dos arquivos de origem em um SnapLock volume. 
---
