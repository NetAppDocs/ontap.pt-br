...
summary: Quando o balanceador de dados automático está ativado, o balanceador analisa as estatísticas de uso dos agregados para identificar o agregado que excedeu a porcentagem de uso de limite superior configurada. 
---
