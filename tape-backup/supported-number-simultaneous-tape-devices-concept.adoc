...
summary: ONTAP suporta um máximo de 64 conexões simultâneas de unidade de fita, 16 trocadores de mídia e 16 dispositivos de ponte ou roteador para cada sistema de storage, em qualquer combinação de conexões Fibre Channel, SCSI ou SAS. 
---
