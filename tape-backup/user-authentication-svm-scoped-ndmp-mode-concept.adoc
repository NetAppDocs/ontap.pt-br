...
summary: No modo NDMP com escopo de máquina virtual de armazenamento, a autenticação do usuário NDMP é integrada ao controle de acesso baseado em funções. No contexto da SVM, o usuário NDMP deve ter a função vsadmin ou vsadmin-backup. No contexto de cluster, o usuário NDMP deve ter a função admin ou backup. 
---
