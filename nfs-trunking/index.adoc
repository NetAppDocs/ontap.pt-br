...
summary: A partir do ONTAP 9.14.1, clientes NFS que executam a versão 4.1 ou posterior podem aproveitar a funcionalidade de trunking de sessão para abrir várias conexões com o servidor NFS, aumentando assim a velocidade de transferência de dados e proporcionando resiliência por meio de multipathing. 
---
