...
summary: 'Você pode usar o comando `security certificate generate-csr` para gerar uma solicitação de assinatura de certificado. Após processar sua solicitação, a autoridade certificadora envia o certificado digital assinado.' 
---
