...
+
** link:https://docs.netapp.com/us-en/ontap-systems/aff-aseries/index.html["Sistemas da série AFF A"^]
...
[NOTE]
====
Para obter mais informações sobre como configurar um cluster usando a GUI de configuração, consulte o link:../task_admin_add_nodes_to_cluster.html["documentação de gerenciamento de nós"]. Saiba mais sobre `cluster setup` no link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["Referência do comando ONTAP"^].
