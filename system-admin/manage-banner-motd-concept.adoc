...
summary: ONTAP permite configurar um banner de login ou uma mensagem do dia para comunicar informações administrativas ao System Manager e aos usuários da CLI do cluster ou do sistema de storage virtual. 
---
