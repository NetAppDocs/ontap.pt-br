...
summary: Você pode habilitar ou desabilitar um serviço web para o cluster ou uma máquina virtual de storage, exibir as configurações dos serviços web e controlar se os usuários de uma função podem acessar um serviço web. 
---
