...
summary: 'O subtipo de certificado do Protocolo de Interoperabilidade de Gerenciamento de Chaves (KMIP), juntamente com os tipos client-ca e server-ca, especifica que o certificado é usado para autenticar mutuamente o cluster e um gerenciador de chaves externo, como um servidor KMIP.' 
---
