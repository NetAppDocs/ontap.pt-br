...
summary: 'Os comandos e parâmetros do ONTAP são definidos em três níveis de privilégio: admin, advanced e diagnostic. Os níveis de privilégio refletem os níveis de habilidade necessários para executar as tarefas.' 
---
