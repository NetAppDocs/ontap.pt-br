...
+
** Isso pode incluir link:../encryption-at-rest/secure-purge-data-encrypted-volume-concept.html["limpando dados de um volume criptografado"].
...
* Todos os LIFs entre clusters foram link:../networking/delete_a_lif.html["removido"].
+
...
+
.. Torne inelegível o nó principal atual para participar no cluster:
+
[source, cli]
----
