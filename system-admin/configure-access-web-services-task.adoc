...
summary: A configuração de acesso a serviços web permite que usuários autorizados utilizem HTTP ou HTTPS para acessar o conteúdo do serviço no cluster ou em uma máquina virtual de storage. 
---
