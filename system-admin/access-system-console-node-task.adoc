...
summary: Se um nó estiver travado no menu de inicialização ou no prompt do ambiente de inicialização, você só poderá acessá-lo através do console do sistema. Você pode acessar o console do sistema de um nó por meio de uma conexão SSH com o SP ou com o cluster. 
---
