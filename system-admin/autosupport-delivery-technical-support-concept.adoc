...
====
Se você quiser desativar o AutoSupport OnDemand, mas manter o AutoSupport habilitado, use o comando: Link:https://docs.NetApp.com/US-en/ONTAP-cli/system-node-AutoSupport-moDIFY.html[`system node autosupport modify -ondemand-state disable`.
