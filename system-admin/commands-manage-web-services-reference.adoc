...
summary: Você usa os comandos web dos serviços do vserver para gerenciar a disponibilidade dos serviços web para o cluster ou uma máquina virtual de storage. Você usa os comandos de acesso web dos serviços do vserver para controlar o acesso de uma função a um serviço web. 
---
