...
summary: Os administradores de cluster gerenciam todo o cluster e as máquinas virtuais de armazenamento que ele contém. Os administradores de SVM gerenciam apenas suas próprias SVMs de dados. 
---
