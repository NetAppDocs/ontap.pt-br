...
summary: A interface de linha de comando do ONTAP fornece uma visão baseada em comandos da interface de gerenciamento. Você insere comandos no prompt do sistema de storage, e os resultados dos comandos são exibidos em texto. 
---
