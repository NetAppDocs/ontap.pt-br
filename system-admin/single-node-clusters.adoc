...
summary: Um cluster de nó único é uma implementação especial de um cluster executado em um nó independente. Clusters de nó único não são recomendados porque não oferecem redundância. Se o nó falhar, o acesso aos dados será perdido. 
---
...
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Relatório técnico da NetApp 4684: Implementando e configurando SANs modernas com NVMe-of"^]
