...
summary: Se houver quorum em todo o cluster, mas um ou mais nós estiverem dessincronizados com o cluster, você deve sincronizar o nó para restaurar o banco de dados replicado no nó e trazê-lo ao quorum. 
---
