...
summary: Em determinadas plataformas de hardware, o software é personalizado para suportar um novo controlador integrado chamado Baseboard Management Controller. O BMC possui comandos de interface de linha de comando que você pode usar para gerenciar o dispositivo remotamente. 
---
