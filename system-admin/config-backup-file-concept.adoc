...
summary: Os arquivos de backup de configuração são arquivos compactados que contêm informações sobre todas as opções configuráveis necessárias para o cluster e os nós dentro dele operarem corretamente. 
---
