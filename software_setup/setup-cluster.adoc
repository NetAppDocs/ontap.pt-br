...
.Sobre esta tarefa
Este procedimento aplica-se a link:https://docs.netapp.com/us-en/ontap-systems-family/index.html["AFF, ASA FAS"^] e link:https://docs.netapp.com/us-en/ontap-afx/index.html["Sistemas AFX"^]. Se você possui um sistema ASA r2 (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 ou ASA C30), siga as instruções abaixo. link:https://docs.netapp.com/us-en/asa-r2/install-setup/initialize-ontap-cluster.html["estes passos"^] Utilizar o System Manager para configurar um cluster ONTAP . Os sistemas ASA r2 oferecem uma experiência ONTAP simplificada, específica para clientes que utilizam apenas SAN.
